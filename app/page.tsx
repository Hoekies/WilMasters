          ...
          <>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {playerRows.map((row, i) => (
                <div key={i} className="flex gap-2 items-center rounded-xl px-3 py-2" style={{ background: '#d8d8d8', border: '1px solid #c8dcc8' }}>
              ...
              {playerRows.length < 30 && (
                <button onClick={addPlayer} className="self-start flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-sm font-medium transition-colors"
                  style={{ background: '#d8d8d8', border: '1px solid #243028', color: '#2e8c3e' }}>
